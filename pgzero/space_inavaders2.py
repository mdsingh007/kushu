...
def move_alien():
    global alien_move_x, top_left_alien_x

    subs = 20
    move_dir = 1 # could be 1 or -1

    if move_dir and alien_move_x > 200:
        move_dir = -1
    elif move_dir == -1 and alien_move_x < -200:
        move_dir = 1

    alien_move_x += subs*move_dir
