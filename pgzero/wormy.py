...
def runGame():
    ...
    while True: # main game loop
        ...
        drawScore(numKeyPress, 'KeyPress', 380)
...
def drawScore(score, txt = 'Score', pos = 120):
    scoreSurf = BASICFONT.render(f'{txt} - {score}', True, WHITE)
    scoreRect = scoreSurf.get_rect()
    scoreRect.topleft = (WINDOWWIDTH - pos, 10)
